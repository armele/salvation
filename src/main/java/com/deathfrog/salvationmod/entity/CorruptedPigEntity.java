...
{
    public CorruptedPigEntity(final EntityType<? extends Monster> type, final Level level)
    {
        super(type, level);
        this.xpReward = 8;
    }
    ...
    {
        return CombatEffects.corruptionAttributeEffects(null, 30.0D, .25D, 2.0D, 28.0D, 2.0D);
    }
    ...
    protected void playStepSound(final @Nonnull BlockPos pos, final @Nonnull BlockState state)
    {
        ...
        this.playSound(NullnessBridge.assumeNonnull(SoundEvents.PIG_STEP), 0.15F, 1.0F);
    }
