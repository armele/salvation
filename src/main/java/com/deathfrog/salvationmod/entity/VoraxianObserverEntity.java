...
public class VoraxianObserverEntity extends Monster implements RangedAttackMob
{
    public VoraxianObserverEntity(final EntityType<? extends Monster> type, final Level level)
    {
        super(type, level);
        this.xpReward = 8;
    ...
    public void tick()
    {
        ...
        {
            // When idle, keep the body and head aligned so hover steering does not produce rapid twisty snaps.
    ...
    {
        // Hovering observers should not accumulate or apply fall damage.
    }
