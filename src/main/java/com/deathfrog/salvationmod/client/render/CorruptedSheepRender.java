...
public class CorruptedSheepRender extends MobRenderer<CorruptedSheepEntity, CorruptedSheepModel<CorruptedSheepEntity>>
{

    private static final ResourceLocation TEXTURE =
        ResourceLocation.fromNamespaceAndPath(SalvationMod.MODID, "textures/entity/corrupted_sheep.png");

    public CorruptedSheepRender(final EntityRendererProvider.Context ctx)
    {
        super(ctx, new CorruptedSheepModel<>(ctx.bakeLayer(CorruptedSheepModel.LAYER_LOCATION)), 0.7F);
    }

    @Override
    public ResourceLocation getTextureLocation(final @Nonnull CorruptedSheepEntity entity)
    {
        return TEXTURE;
    }

    @Override
    public void render(final @Nonnull CorruptedSheepEntity entity, float entityYaw, float partialTicks,
