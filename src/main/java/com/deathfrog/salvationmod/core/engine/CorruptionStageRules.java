...
public record CorruptionStageRules(
    ...
    float fightBackCorruptionChance,
    float blockCorruptionChance,
    int blockCorruptionAmount,
    ...
    Optional<String> transitionMessageKey)
{
    ...
    public static final Codec<CorruptionStageRules> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        Codec.floatRange(0.0F, 1.0F).optionalFieldOf("fight_back_corruption_chance", 0.0F).forGetter(CorruptionStageRules::fightBackCorruptionChance),
        Codec.floatRange(0.0F, 1.0F).optionalFieldOf("block_corruption_chance", 0.0F).forGetter(CorruptionStageRules::blockCorruptionChance),
        Codec.intRange(0, Integer.MAX_VALUE).optionalFieldOf("block_corruption_amount", 0).forGetter(CorruptionStageRules::blockCorruptionAmount),
