...
public class TileEntityInitializer
{
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
        DeferredRegister.create(Registries.BLOCK_ENTITY_TYPE, SalvationMod.MODID);

    static
    {
        SalvationTileEntities.BUILDING = BLOCK_ENTITIES.register("salvation_colonybuilding",
            () -> BlockEntityType.Builder.of(SalvationTileEntityColonyBuilding::new, ModBuildings.getHuts())
        ...
        SalvationTileEntities.PURIFYING_FURNACE = BLOCK_ENTITIES.register("purifying_furnace",
